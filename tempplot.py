...
Comment: This script navigates to a directory containing our temperature data files generated by our R-Pi unit, converts the data points to corresponding temperatures for our hardware and displays a plot of the results
"""
...
data_path = './temp_2017_11_6.txt'
data = pd.read_csv(data_path, sep = " ", engine='python', header=None)  #Parsing file
...
ax = data.plot(x = 'Time1', y = 'ULE Temp', marker = 'o')
...
plt.xlabel('Time on Nov 6 [pm]')
plt.title('ULE Temperature Durring Rb Stark Shift Measurement')
#ax = data.plot(x = 'Time1', y = 'ULE Temp')
